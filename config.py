...
#chromeProfilePath = r"C:\\Users\\DELL\\AppData\\Local\\Google\\Chrome\\User Data\\Profile 1"
...
blacklistCompanies = ["CVS Health", "CVS Health Retail", "CVS Health Enterprise Analytics", "CVS Health - Retail", "CVS Health - Finance", "CVS Health - Digital", "CVS Health - Enterpris", "Dexian", "Signature", "Jobot", "Cash App", "Crossover"]
#Blaclist keywords in title - ex:["manager", ".Net"]
blackListTitles = ["AI Prompt Engineer", "AI-Augmented Software Developer"]

summary_of_experience = "6 years of experience with Test automation, selenium webdriver, python programming language, C#, Jenkins, DevOps, Jira, SQL, agile methodologies, robot framework, browserstack, test cases, Testrail, test scenarios, scrum, user acceptance testing, git, continuous integration, qa/qc, Linux, REST API, unit testing, slack, azure boards, Microsoft azure test plans."

#blackListTitles = ["software engineer", "Software developer", "AI Prompt Engineer, gt.school (Remote) - $100,000/year USD", "AI Super Engineer, Trilogy (Remote) - $200,000/year USD"]
